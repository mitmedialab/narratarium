...
struct  FtpWebRequest_t611  : public WebRequest_t607
{
	...
	RemoteCertificateValidationCallback_t610 * ___callback_15;
};
struct FtpWebRequest_t611_StaticFields{
	...
	RemoteCertificateValidationCallback_t610 * ___U3CU3Ef__amU24cache1C_16;
};
