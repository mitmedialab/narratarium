...
public class SpeechRecognition : MonoBehaviour {
	...
	private SpeechAnimationDictionary speechDictionary = null;
	...
	public static SpeechAnimationDictionary GetSpeechAnimationDictionary(){
	...
	public static HashSet<string> GetCommandRecognized(){
		return activeCommandsInThisFrame;
	}
	...
	public string loadFile(string fileName){
		...
		{
			Debug.Log("Problem loading"+e.ToString());
			return "";
